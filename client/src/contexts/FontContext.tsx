import {
  ...
  import { FontType, TextSizeType, TextBoldnessType } from '../types';
  ...
  export const FontProvider = ({ children }: { children: ReactNode }) => {
    ...
    return <FontContext.Provider value={{ font, setFont, textSize, setTextSize, textBoldness, setTextBoldness }}>{children}</FontContext.Provider>;
  };
